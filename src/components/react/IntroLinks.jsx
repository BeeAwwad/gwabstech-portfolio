...
const IntroLinks = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-7 max-w-sm md:max-w-2xl lg:max-w-5xl mx-auto gap-4">
      <div className="bg-[#31363F] rounded-xl flex flex-col justify-between p-5 xl:col-span-3 space-y-5 text-[#eee]">
        ...
        <div className="flex flex-col gap-5">
          ...
          <a
            href="/experience"
            className="p-1.5 hover:bg-[#eee] hover:text-[#31363F] transition-colors border-2 border-white w-fit ml-auto"
          >
